<template>
    <div class="flex justify-center my-16" v-if="!changePassword">
        <div class="md:w-8/12 lg:ml-6 lg:w-5/12">
            ...
            <RouterLink :to="{name: 'RegisterView'}">
                <div
                    class="bg-blue-primary mb-3 flex w-full items-center justify-center rounded px-7 pb-2.5 pt-3 text-center text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]"
                    role="button"
                    data-te-ripple-init
                    data-te-ripple-color="light">
                    Créer un compte
    ...
    <div class="text-center flex justify-center my-16 h-screen text-sm min-[350px]:text-lg" v-if="changePassword">
        Cliquer sur le lien reçu par mail pour changer votre mot de passe !
    </div>
</template>
    ...
    const checkLogin = async() => { 
        if(mail.value === '' || password.value === ''){
            ...
            try {
                ...
                const response = await axios.post('https://nathimmo-backend.cluster-ig3.igpolytech.fr/user/login',{
